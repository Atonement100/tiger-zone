...
public class ScoreController {
    ...
    public ArrayList<Tiger> handleDens(Tile confirmedTile, MoveInformation moveInfo){
        ArrayList<Tiger> tigersToReturn = new ArrayList<>();
        //**************************************************************************************************************
    ...
    public ArrayList<Tiger> scoreTrail(Node start){
        ArrayList<Tiger> tigersToReturn = new ArrayList<>();
        int[] tigersReturned = new int[2];
        roadIdentifier++;
    ...
    boolean isTrailScorable(Node start){
    ...
    public ArrayList<Tiger> scoreIncompleteLake(Node start){
    ...
    public ArrayList<Tiger> scoreCompleteLake(Node start){
        ArrayList<Tiger> tigersToReturn = new ArrayList<>();
        lakeIdentifier++;
        int[] tigersReturned = new int[2];
    ...
    public ArrayList<Node> getShoreCycleNodes(Node start){
    ...
    public ArrayList<Node> getTrailCycleNodes(Node start){
