...
public class Tile {
    ...
    public static void printTile(Tile toPrint){
        ...
        System.out.println("");
        System.out.println(toPrint.edges[0].nodes[2].featureType.toChar() + "   " + toPrint.edges[2].nodes[2].featureType.toChar());
        System.out.println(toPrint.edges[0].nodes[1].featureType.toChar() + "   " + toPrint.edges[2].nodes[1].featureType.toChar());
        System.out.println(toPrint.edges[0].nodes[0].featureType.toChar() + "   " + toPrint.edges[2].nodes[0].featureType.toChar());
        System.out.print(" ");
        for(int i = 0; i < 3; i++){
