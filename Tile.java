...
public class Tile {
	...
	public void connectNodes(){
		if(this.edges[0].nodes[1].featureType == FeatureTypeEnum.Trail && this.edges[2].nodes[1].featureType == FeatureTypeEnum.Trail && this.middle.featureType == FeatureTypeEnum.Trail){
